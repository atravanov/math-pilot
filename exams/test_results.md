...
überprüfen.
- Du kannst mittels einer vorgegebenen Wahrheitstabelle einer boolschen Funktion die volständige DNF resp. CNF der Funktion herleiten.
...
### Lösung 3
Sei x = "a ist eine Primzahl" und y = "a ist eine ungerade Zahl". Dann können wir die beiden Aussagen wie folgt vergleichen:
$$ (x \Rightarrow y) = \lnot x \lor y$$

Der Vergleich mittels Wahrheitstabellen ergibt, das die beiden Aussagen logisch gleichwertig sind:

### Aufgabe 12
Die Wahrheitstabelle einer boolschen Funktion lautet: 0100 0011. Wie lautet die vollständige DNF (= disjunktive Normalform) für diese Funktion?
